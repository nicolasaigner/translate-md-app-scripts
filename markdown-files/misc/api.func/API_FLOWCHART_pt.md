# Fluxograma de Execução da API

## Fluxo Principal de Comunicação da API
...
## Fluxo de Relatório da API de Máquina Virtual
...
- **build.func**: Envia dados de instalação do LXC
- **vm-core.func**: Envia dados de instalação da máquina virtual
- **install.func**: Reporta o status da instalação
- **alpine-install.func**: Reporta dados de instalação do Alpine

### Com Tratamento de Erros

- **error_handler.func**: Fornece explicações de erros
- **core.func**: Utiliza descrições de erros na execução silenciosa
- **Relatórios de diagnóstico**: Rastreia padrões de erros

### Dependências externas

- **curl**: Cliente HTTP para comunicação com a API
- **API de Scripts da Comunidade**: Endpoint da API externa
- **Conectividade de rede**: Necessária para comunicação com a API
