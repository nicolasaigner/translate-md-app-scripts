# Exemplos de uso de `build.func`

## Visão geral

Este documento fornece exemplos práticos de uso para `build.func`, abrangendo cenários comuns, exemplos de linha de comando e combinações de variáveis ​​de ambiente.

## Exemplos de Uso Básico

### 1. Criação Simples de Contêiner

**Cenário**: Criar um contêiner básico para um servidor de mídia Plex
...
**Cenário**: Criar um contêiner Nextcloud com configurações personalizadas
...
### 3. Configuração de Passagem de GPU

**Cenário**: Criar um contêiner Jellyfin com passagem de GPU NVIDIA
...
**Cenário**: Implantar múltiplos contêineres sem interação do usuário
...
**Cenário**: Criar contêineres de desenvolvimento com configurações específicas Configurações
...
**Cenário**: Criar um contêiner com suporte a VLAN
...
### 2. Configuração de IPv6

**Cenário**: Criar um contêiner com suporte a IPv6
...
### 1. Locais de Armazenamento Personalizados

**Cenário**: Usar armazenamento diferente para modelos e contêineres
...
### 2. Armazenamento de Alto Desempenho

**Cenário**: Usar armazenamento de alto desempenho para aplicações que exigem muitos recursos
...
### 1. Contêiner Privilegiado

**Cenário**: Criar um contêiner privilegiado para nível de sistema Acesso
...
### 2. Contêiner sem privilégios

**Cenário**: Criar um contêiner seguro sem privilégios
...
### 1. Salvar padrões globais

**Cenário**: Salvar as configurações atuais como padrões globais
...
### 2. Salvar padrões específicos do aplicativo

**Cenário**: Salvar as configurações como padrões específicos do aplicativo
...
**Cenário**: Tratar erros de validação de configuração
...
### 2. Tratamento de erros de armazenamento

**Cenário**: Tratar a seleção de armazenamento Erros
...
### 1. Com Scripts de Instalação

**Cenário**: Integrar com scripts de instalação de aplicativos
...
**Cenário**: Integrar com sistemas de monitoramento
...
### 2. Tratamento de Erros e Registro de Logs
